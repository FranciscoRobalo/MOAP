...
const translations = {
  pt: {
    ...
    registerSubtitle: "Preencha os dados para solicitar acesso à plataforma",
    ...
    registrationNote:
      "O seu pedido de registo será analisado pela nossa equipa. Receberá um email de confirmação em webmaster@moap.com quando a sua conta for aprovada.",
    alreadyHaveAccount: "Já tem uma conta?",
    loginHere: "Entrar aqui",
    noAccount: "Ainda não tem conta?",
    registerHere: "Registar aqui",
    registrationSubmitted: "Registo Submetido!",
    registrationPendingMessage:
      "O seu pedido de registo foi recebido com sucesso. A nossa equipa irá analisar os seus dados e entrará em contacto em breve.",
    ...
    usernameExists: "Este nome de utilizador já está em uso",
    ...
    budgetApproval: "Aprovações",
    budgetReviews: "Revisão de Orçamentos",
    mySubmissions: "Os meus orçamentos",
    clients: "Clientes",
    ...
    registrationRejected: "Registo rejeitado",
  ...
  en: {
    ...
    registerSubtitle: "Fill in your details to request platform access",
    fullName: "Full Name",
    ...
    registrationNote:
      "Your registration request will be reviewed by our team. You will receive a confirmation email at webmaster@moap.com when your account is approved.",
    ...
    registrationPendingMessage:
      "Your registration request has been received successfully. Our team will review your details and contact you soon.",
    ...
    budgetApproval: "Approvals",
    budgetReviews: "Budget Reviews",
    mySubmissions: "My Budgets",
    clients: "Clients",
    builders: "Builders",
  ...
  es: {
    ...
    registerSubtitle: "Complete los datos para solicitar acceso a la plataforma",
    fullName: "Nombre Completo",
    fullNamePlaceholder: "Introduzca su nombre",
    ...
    registrationNote:
      "Su solicitud de registro será analizada por nuestro equipo. Recibirá un email de confirmación en webmaster@moap.com cuando su cuenta sea aprobada.",
    ...
    registrationPendingMessage:
      "Su solicitud de registro se ha recibido correctamente. Nuestro equipo analizará sus datos y se pondrá en contacto pronto.",
    contactEmail: "Email de contacto",
    ...
    budgetApproval: "Aprobaciones",
    budgetReviews: "Revisión de Presupuestos",
    mySubmissions: "Mis presupuestos",
    clients: "Clientes",
