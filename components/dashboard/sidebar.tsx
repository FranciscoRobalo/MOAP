...
const navigation: NavItem[] = [
  ...
  { nameKey: "clients", href: "/dashboard/users?type=cliente", icon: Users, roles: ["admin", "public", "tecnico"] },
  { nameKey: "builders", href: "/dashboard/users?type=construtor", icon: Users, roles: ["admin", "public", "tecnico"] },
  { nameKey: "contractors", href: "/dashboard/users?type=empreiteiro", icon: Users, roles: ["admin", "public", "tecnico"] },
