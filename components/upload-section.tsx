...
export function UploadSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Read the file as base64 and store in sessionStorage so it survives navigation
          ...
          <Card className="border-border/40 bg-card/50">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" size="lg" className="w-full gap-2" disabled={!file || isLoading}>
                  {isLoading ? (
                    <>
                ...
                <p className="text-center text-xs text-muted-foreground">
                  Ser-lhe-a pedido que inicie sessao ou crie uma conta para continuar a analise.
                </p>
              </form>
            </CardContent>
          </Card>
